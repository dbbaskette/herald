...
class HeraldConfigTest {
    ...
    void dbPathUsesConfiguredValue() {
        HeraldConfig config = new HeraldConfig(
                new HeraldConfig.Memory("/custom/path/herald.db"), null, null, null, null, null, null, null, null);
    ...
    void dbPathUsesConfiguredTildePath() {
        HeraldConfig config = new HeraldConfig(
                new HeraldConfig.Memory("~/custom/herald.db"), null, null, null, null, null, null, null, null);
    ...
    void personaUsesConfiguredValue() {
        HeraldConfig config = new HeraldConfig(null, null,
                new HeraldConfig.Agent("Custom Persona", null, null, null, null), null, null, null, null, null, null);
    ...
    void systemPromptExtraUsesConfiguredValue() {
        HeraldConfig config = new HeraldConfig(null, null,
                new HeraldConfig.Agent(null, "Extra instructions", null, null, null), null, null, null, null, null, null);
    ...
    void contextFileUsesConfiguredValue() {
        HeraldConfig config = new HeraldConfig(null, null,
                new HeraldConfig.Agent(null, null, "/custom/CONTEXT.md", null, null), null, null, null, null, null, null);
    ...
    void weatherLocationUsesConfiguredValue() {
        HeraldConfig config = new HeraldConfig(null, null, null, null, null,
                new HeraldConfig.Weather("New+York"), null, null, null);
    ...
    void weatherLocationDefaultsToEmptyWhenBlank() {
        HeraldConfig config = new HeraldConfig(null, null, null, null, null,
                new HeraldConfig.Weather("  "), null, null, null);
        assertThat(config.weatherLocation()).isEmpty();
    }
}
